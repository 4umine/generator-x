...
public class XMLMapperGenerator extends AbstractXmlGenerator {
    ...
    protected XmlElement getSqlMapElement() {
        ...
        addBaseColumnPrefixListElement(answer);
    ...
    /** add by https://somelosg.com **/
    protected void addBaseColumnPrefixListElement(XmlElement parentElement) {
        if (introspectedTable.getRules().generateBaseColumnPrefixList()) {
            AbstractXmlElementGenerator elementGenerator = new BaseColumnPrefixListElementGenerator();
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
    }
